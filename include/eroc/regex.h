...
enum eroc_regex_ast_node_type
{
    ...
    EROC_REGEX_AST_PSEUDOINSTRUCTION_START_CAPTURE,
    EROC_REGEX_AST_PSEUDOINSTRUCTION_END_CAPTURE,
    EROC_REGEX_AST_PSEUDOINSTRUCTION_ALTERNATE,
    EROC_REGEX_AST_PSEUDOINSTRUCTION_LITERAL,
    EROC_REGEX_AST_PSEUDOINSTRUCTION_START_RANGE,
};
...
enum eroc_regex_compiler_state
{
    ...
    EROC_REGEX_COMPILER_STATE_SCAN_IN_ESCAPE,
    EROC_REGEX_COMPILER_STATE_IN_CHAR_CLASS_MAYBE_INVERT,
    EROC_REGEX_COMPILER_STATE_IN_CHAR_CLASS,
    EROC_REGEX_COMPILER_STATE_IN_CHAR_CLASS_ESCAPE,
